...
class GeografisService {
  static Future<List<Geografis>> fetchGeografis() async {
    ...
    final response = await http.get(
      Uri.parse('${Env.baseUrl}/geografis'),
      headers: {
    ...
    if (response.statusCode == 200) {
      ...
      return list.map((json) => Geografis.fromJson(json)).toList();
    } else {
      print('Status: ${response.statusCode}');
      print('Response: ${response.body}');
      throw Exception('Gagal mengambil data Geografis');
    }
  }
}
